...
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Yash Khokale', 'qwesa123', N'06/19/1997', N'yashkhokale@gmail.com', N'170, Vakhar Bhag, Sangli.', 6174126121)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Anish Naik','qwesf123', N'09/12/1997', N'naik.ani@husky.neu.edu', N'451, Park Drive, Boston, MA', 6172596134)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Bhumika Punjabi','qcxvwe123', N'05/02/2008', N'bhumikapunjabi2294@gmail.com', N'432, Boylston Street, Boston, MA', 6825535655)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Cash Johnson','asqwe123', N'06/10/2019', N'cashj@gmail.com', N'Pragati colony, Sangli, MH', 6174126123)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Rock K', 'dsadqwe123', N'10/11/2020', N'rocky@gmail.com', N'Fenway Park, boston, MA', 8421564564)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Hunter Kelen','vcxvqwe123', N'09/08/2001', N'hunty@gmail.com', N'250, Emerald Necklace, boston, MA', 9876543210)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Joey Tribianni ','vcxqwe123', N'04/01/1998', N'joeyhowudoing@gmail.com', N'Central Park, New York City, NY', 1430001430)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Ross Geller','qfgwe123', N'04/02/1998', N'rossunagi@gmail.com', N'Ungly guy, NYC, NY', 3426517894)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Chandler Bing','dgqwe123', N'04/03/1998', N'iknewit@gmail.com', N'Monica''s Apt, NYC, NY', 5461237894)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Gunther ','qgweh123', N'04/04/1998', N'iloveracheal@gmail.com', N'Centerl Perk, Down town, NYC, NY', 8456482123)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Yash Green','qsdfwe123', N'06/19/1997', N'yashkhokale@gmail.com', N'170, Vakhar Bhag, Sangli.', 6174126121)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Anish Bing','sfsqwe123', N'09/12/1997', N'naik.ani@husky.neu.edu', N'451, Park Drive, Boston, MA', 6172596134)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Jonny Malhotra','ccxvqwe123', N'05/02/2008', N'jonnymalhotra@gmail.com', N'432, Boylston Street, Boston, MA', 6174126122)
GO
INSERT [dbo].[User] ( [User_Name], [PasswordHash], [Date_of_Birth], [Email_Address], [Address], [Contact_Number]) VALUES ( N'Cash Johnson','xvdsvqwe123', N'06/10/2019', N'cashj@gmail.com', N'Pragati colony, Sangli, MH', 6174126123)
GO
